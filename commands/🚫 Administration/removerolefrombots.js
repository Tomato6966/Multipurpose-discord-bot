     ...
     try {
      ...
      let cmdroles = GuildSettings?.cmdadminroles?.removerolefrombots || [];
       ...
       message.reply({embeds:  [new MessageEmbed()
         ...
         .setFooter(client.getFooter(es))
         .setAuthor(`Changing roles for ${members.length} Bots...`, "https://images-ext-1.discordapp.net/external/ANU162U1fDdmQhim_BcbQ3lf4dLaIQl7p0HcqzD5wJA/https/cdn.discordapp.com/emojis/756773010123522058.gif", "http://discord.gg/7PdChsBGKd")
