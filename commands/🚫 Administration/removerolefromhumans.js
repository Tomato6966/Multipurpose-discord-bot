   ...
   run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
     ...
     try {
      ...
      let cmdroles = GuildSettings?.cmdadminroles?.removerolefromhumans || [];
       ...
       var members = message.guild.members.cache.filter(member => !member.user.bot && member.roles.cache.has(role.id)).map(this_Code_is_by_Cepheid => this_Code_is_by_Cepheid);
       ...
       message.reply({embeds:  [new MessageEmbed()
         ...
         .setFooter(client.getFooter(es))
         .setAuthor(`Changing roles for ${members.length} Humans...`, "https://images-ext-1.discordapp.net/external/ANU162U1fDdmQhim_BcbQ3lf4dLaIQl7p0HcqzD5wJA/https/cdn.discordapp.com/emojis/756773010123522058.gif", "http://discord.gg/7PdChsBGKd")
