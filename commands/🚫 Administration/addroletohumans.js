     ...
     try {
      ...
      let cmdroles = GuildSettings?.cmdadminroles?.addroletohumans || [];
       ...
       message.reply({embeds:  [new MessageEmbed()
         ...
         .setFooter(client.getFooter(es))
         .setAuthor(`Changing roles for ${members.length} Humans...`, "https://images-ext-1.discordapp.net/external/ANU162U1fDdmQhim_BcbQ3lf4dLaIQl7p0HcqzD5wJA/https/cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/dcdev")
