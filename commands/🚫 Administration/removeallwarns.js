const { MessageEmbedn, Permissions } = require(`discord.js`);
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                ...
                                .setFooter(client.getFooter(es))
                                .setAuthor(
                                    `${message.author.tag} removed all ${warnIDs.length - toaddids.length} Warnings of **\`${message.guild.name}\`** from you!`,
