          ...
          await tempmsg.channel.awaitMessages({
            ...
            .then(async collected => {
              try {
                ...
                message.reply({
                  embeds: [new Discord.MessageEmbed()
                    .setTitle(`<a:Yes:964306724821536768> Set the TWITTER USER ID TO: \`${collected.first().content}\``.substring(0, 256))
                ...
                await tempmsg.channel.awaitMessages({
                  ...
                  .then(async collected => {
                    try {
                      ...
                      return message.reply({
                        embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:Yes:964306724821536768> Set the TWITTER USER Name TO: \`${collected.first().content}\``.substring(0, 256))
