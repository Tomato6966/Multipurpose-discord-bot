    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Auto Delete Setup', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'http://discord.gg/7PdChsBGKd'))
              ...
              .then(async collected => {
                ...
                if (channel) {
                  try {
                    ...
                    if(!time || isNaN(time))
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`:x: Invalid Input | Time wrong`)
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`:white_check_mark: I will now delete Messages after \`${time} Seconds\` in **${channel.name}**`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
              ...
              .then(async collected => {
                ...
                if (channel) {
                  try {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`:white_check_mark: Successfully removed **${channel.name}** out of the Setup!`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
