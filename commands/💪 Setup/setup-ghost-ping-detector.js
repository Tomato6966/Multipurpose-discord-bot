    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Ghost-Ping-Detector Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/bookmark_1f516.png', 'http://discord.gg/7PdChsBGKd'))
                  ...
                  if (channel) {
                    try {
                      ...
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`:white_check_mark: I will now send all detected Ghost Pings in \`${channel.name}\``)
                        .setColor(es.color)
