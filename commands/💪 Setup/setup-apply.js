  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    async function first_layer() {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Application Setup', 'https://cdn.discordapp.com/emojis/877653386747605032.png?size=96', 'http://discord.gg/7PdChsBGKd'))
    ...
    async function second_layer(SetupNumber, menuoptiondata) {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor(SetupNumber + " Apply Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", "http://discord.gg/7PdChsBGKd"))
                                ...
                                msg.channel.awaitMessages({
                                  ...
                                  if (collected.first().content.toLowerCase() === "no") {
                                    ...
                                    if (!message.guild.me.roles) return message.reply({
                                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable25"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                        dynamic: true
                                      })))]
                                    })
                    ...
                    message.reply({
                      ...
                      msg.channel.awaitMessages({
                        ...
                        if (collected.first().content.toLowerCase() === "no") {
                          ...
                          if (!message.guild.me.roles) return message.reply({
                            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable58"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                              dynamic: true
                            })))]
                          })
          ...
          case "acceptrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable70"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  })))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable71"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable81"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable82"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable100"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable101"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable119"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable120"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable140"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable141"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable161"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable162"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
          ...
          case "temprole":
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable183"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  })))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable184"])).setAuthor(client.getAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                }
