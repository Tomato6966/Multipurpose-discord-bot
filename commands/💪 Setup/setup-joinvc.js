    ...
    try {//ensure the database
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Join VC System', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'http://discord.gg/7PdChsBGKd'))
        ...
        switch (optionhandletype){
          case "Send Message in a Channel":{
            ...
            async function second_layer(){
              ...
              let MenuEmbed = new Discord.MessageEmbed()
                .setColor(es.color)
                .setAuthor('Join VC System', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'http://discord.gg/7PdChsBGKd')
                .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-ticket"]["variable2"]))
              //send the menu msg
              let menumsg = await message.reply({embeds: [MenuEmbed], components: [new MessageActionRow().addComponents(Selection)]})
              //Create the collector
                      ...
                      try {
                        ...
                        if(a.map(d => d.channelId).includes(Voicechannel.id))
                          return message.reply({embeds: [new Discord.MessageEmbed()
                            .setTitle(`:x: This Channel is already Setupped!`)
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`:white_check_mark: I will now send Messages after someone joins the VC \`${Voicechannel.name}\` in the TextChannel **${Textchannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author?.id,
                    ...
                    .then(async collected => {
                      ...
                      try {
                        ...
                        if(!a.map(d => d.channelId).includes(Voicechannel.id))
                          return message.reply({embeds: [new Discord.MessageEmbed()
                            .setTitle(`:x: This Channel has not been Setup yet!`)
                            .setColor(es.color)
                            .setFooter(client.getFooter(es))
                          ]});
                        await dbRemove(client.joinvc, message.guild.id+".vcmessages", d => d.channelId == Voicechannel.id)
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`:white_check_mark: Successfully removed **${Voicechannel.name}** out of the Setup!`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author?.id,
                    ...
                    .then(async collected => {
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`:white_check_mark: I will now Add the Role \`${Role.name}\` when someone joins the VC **${Discord.VoiceChannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
