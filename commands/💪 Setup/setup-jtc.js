...
module.exports = {
    ...
    try{
      ...
      async function second_layer(SetupNumber, menuoptiondata)
      {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
        .setColor(es.color)
        .setAuthor(client.getAuthor(SetupNumber + " Join-to-Create Setup", 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/joypixels/291/studio-microphone_1f399-fe0f.png', 'http://discord.gg/7PdChsBGKd'))
