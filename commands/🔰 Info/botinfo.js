        ...
        return Promise.all(promises)
          .then(([cluster, shards, guilds, members, ram, rssRam, ping, dbPing, players, uptime]) => {
              ...
              for(let index = 0; index<shards.length; index++) {
                ...
                .addField(
                  `${uptime[index] < 1000 || members[index] < 1 || guilds[index] < 1 ? `:x:` : `:green_circle:`} Cluster #${cluster[index]}${cluster[index] == client.cluster.id ? ` | **Cluster of __this Guild__**` : ``}`, 
