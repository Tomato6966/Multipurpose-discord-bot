  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    try {   
      ...
      try{
        ...
        embeduserinfo.setAuthor(client.getAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: member.user.tag}), member.user.displayAvatarURL({ dynamic: true }), "http://discord.gg/7PdChsBGKd"))
        ...
        embeduserinfo.setAuthor(client.getAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: user.tag}), user.displayAvatarURL({ dynamic: true }), "http://discord.gg/7PdChsBGKd"))
