...
<details>
  <summary>Click to expand</summary>
   ...
   2. Fill in all required data in `./botconfig/config.json` **NOTE:** *If you're on replit.com, it is exposed to everyone!(use .env instead) & if you want access to certain commands like `eval, detailedeval, deployslash`, replace the first owner ID in config.json with yours!*
